...
A collection of **32 browser-based educational games** for kids, covering math, science, language, logic, coding, and creativity. Each game is a single self-contained HTML file, works on desktops, tablets, and interactive smart boards, is bilingual (English / العربية), and installs as an offline-capable web app.
...
| 32 | 🦁 **Sight Word Safari** — `sight_word_safari` | Reading | Read a high-frequency sight word and tap the bush that shows it, building up to tricky lookalikes like was/saw and no/on. | 4 |
